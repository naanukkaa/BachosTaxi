const translations = {
  ...
  whatsappBtn: "WhatsApp",
    ...
    payAdult: "გადაიხადეთ ზრდასრულის ანგარიშით",
    payKids: "გადაიხადეთ ბავშვის ანგარიშით",
    how: "როგორ მუშაობს?",
    step1: "აირჩიეთ ბანკი",
  ...
  en: {
    ...
    pay: "Make transfer",
    payAdult: "Pay (Adult Account)",
    payKids: "Pay (Kids Account)",
  ...
  ru: {
    ...
    payAdult: "Оплатить (Взрослый счет)",
    payKids: "Оплатить (Детский счет)",
